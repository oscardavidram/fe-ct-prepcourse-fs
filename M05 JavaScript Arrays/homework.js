...
function incrementarPorUno(array) {
   ...
   // Tu código:
   masUno = array.map((arr)=>{return arr+1})
   return masUno
}
...
function todosIguales(array) {
   ...
   var arrayIgual = array.every((arr)=>{return arr === primerElemento;})
   return arrayIgual
}
...
function mayorACien(array) {
   ...
   // Tu código:
   var newArray = array.filter((elemento)=>{return elemento>100})
return newArray
}
